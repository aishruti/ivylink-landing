...
export default function Index() {
  ...
  return (
    <div style={{ minHeight: '100vh', width: '100%', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", system-ui, sans-serif' }}>
      ...
      <section style={{ backgroundColor: 'var(--dark-deep)', paddingTop: '80px', paddingBottom: '80px', width: '100%' }}>
        <div
          style={{
            maxWidth: '1000px',
            width: '100%',
      ...
      <section style={{ backgroundColor: 'var(--coral)', paddingTop: '80px', paddingBottom: '80px', width: '100%' }}>
        <div
          style={{
            maxWidth: '640px',
            width: '100%',
